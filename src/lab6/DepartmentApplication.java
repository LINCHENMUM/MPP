...
public class DepartmentApplication {
	...
	public static void main(String[] args) throws IOException {
		...
		StaffStudent frankGoreStud = new StaffStudent("Frank Gore", "472-3321", 33, 4050, 4.0, new GregorianCalendar(2011,1,1));
		StaffStudent adamDavisStud = new StaffStudent("Adam Davis", "472-7552", 50, 5500, 3.6, new GregorianCalendar(2001,11,1));
		StaffStudent davidHeckStud = new StaffStudent("David Heck", "472-8890", 29, 3600, 3.7, new GregorianCalendar(2011,9,1));
		dept.addPerson(frankGoreStud);
		dept.addPerson(adamDavisStud);
		dept.addPerson(davidHeckStud);
		...
		frankGoreStud.addCourse(cs201);
		frankGoreStud.addCourse(cs360);
		adamDavisStud.addCourse(cs404);
		davidHeckStud.addCourse(cs201);
		davidHeckStud.addCourse(cs240);
		davidHeckStud.addCourse(cs450);
		/*
		...
		while (true) {
			...
			putText("getTotalSalary, showAllMembers, unitsPerFaculty, nameOfStudents or quit : ");
			int choice = getChar();
			switch (choice) {
			case 'g':
			...
			case 'u':
				...
				break;
			case 'n':
				putText("Please input name of a faculty member");
				Scanner in = new Scanner(System.in);
				String facultyName = in.nextLine();
				dept.printStudentNames(facultyName);
				break;
			case 'q':
				return;
			default:
